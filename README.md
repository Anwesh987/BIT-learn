...
* **🛡️ Hallucination Checker:** Uses Cosine Similarity to compare the AI's final answer against the raw textbook text. It assigns a color-coded "Hallucination Score" to guarantee absolute academic accuracy.
